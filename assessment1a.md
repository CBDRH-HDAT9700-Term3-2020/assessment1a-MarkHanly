...
To complete your assignment:
  ...
  - `Push` the repo, together with this edited file and the
    corresponding `.md` file to GitHub.
...
1)  Draw a DAG to represent the causal relationship between maternal
    smoking and birth weight. Write a brief descriptive paragraph that
    highlights any backdoor path(s) and the observed variables that
    might be useful to close the path(s). (25%)
...
3)  Fit the model birwt \~ smoke in (i) The raw data and (ii) the
    matched data. Briefly describe the model results. How does the
    estimated effect for smoking change and why? (25%)
